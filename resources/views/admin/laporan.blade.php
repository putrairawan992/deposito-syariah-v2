...
@section('content')
    ...
    <div class="content text-black ml-12 transform ease-in-out duration-500 pt-20 px-2 md:px-5 pb-4 ">
        <div class="p-4 mb-4 rounded-md bg-white">
            <div class="mb-5 md:mb-0 text-lg font-sans font-semibold"> Daftar Semua Promo </div>
            <div class="flex justify-center mb-2" id="loading-tb-promo">
            ...
            <table id="tb-promo" class="display" style="width:100%">
            </table>
        </div>
    </div>

    <!-- Put this part before </body> tag -->
    <input type="checkbox" id="modalPromo" class="modal-toggle" />
    <div class="modal">
        <div class="modal-box bg-white text-gray-800" style="max-width: 45rem">
            <label for="modalPromo" class="absolute top-3 right-4 text-xl cursor-pointer"><i
                    class="far fa-times-circle"></i></label>
            <div class="flex justify-center items-center">
                <img class="cursor-pointer object-cover h-96 rounded-md w-full mt-4"
                    src="https://static.bmdstatic.com/st/home/76e4c0-MB.jpg" alt="">
            </div>
            <div class="font-sans mt-4 font-bold text-xl">PR23232107</div>
            <div class="font-sans">by PT BPR A, Hingga 1 September 2023</div>
            <div class="font-sans mt-1 font-semibold">Deskripsi</div>
            <div class="font-sans">Ada Promo Bank dan Partner, Ayo Bergabung sebelum Kehabisan promonya</div>
        </div>
    </div>
    ...
    <script>
        ...
        function reloadData() {
            $("#loading-tb-promo").fadeIn()
            // ajaxCall(serverApi + 'allnasabah', null, "GET", "showAllPromo")
        }

        function showAllPromo(dataNa) {
            restyleButton()
            var elementId = "tb-promo";
            $("#loading-tb-promo").hide();
            document.getElementById(elementId).innerHTML =
                '<thead><tr><th>Kode</th><th>Gambar</th><th>Deskripsi</th><th>Status</th><th>Expire</th></tr> </thead>'
            var t = "<tbody>";
            for (let i = 0; i < 12; i++) {
                var tr = '<tr class="align-center">';
                tr += '<td class="text-left align-middle" nowrap>PR23232107</td>';
                tr +=
                    '<td class="text-left align-middle" nowrap><label for="modalPromo"><img class="cursor-pointer object-cover h-16 w-36 rounded-md"' +
                ...
                tr +=
                    ...
                    'Aktif' + "</button></td>";
                tr += '<td class="text-left align-middle text-sm font-sans" nowrap>1 September 2023</td>';
                tr += "</td></tr>";
                t += tr;
            }

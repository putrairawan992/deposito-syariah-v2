...
@section('content')
    ...
    <div class="content text-black ml-12 transform ease-in-out duration-500 pt-20 px-2 md:px-5 pb-4 ">
        <div class="p-4 mb-4 rounded-md bg-white">
            <div class="mb-5 md:mb-0 text-lg font-sans font-semibold"> Semua Pemberitahuan </div>
            <div class="flex justify-center mb-2" id="loading-tb-notifikasi">
            ...
            <table id="tb-notifikasi" class="display" style="width:100%">
            </table>
        </div>
    </div>
    ...
    <script>
        ...
        function reloadData() {
            $("#loading-tb-notifikasi").fadeIn()
            // ajaxCall(serverApi + 'allnasabah', null, "GET", "showAllNotofikasi")
        }

        function showAllNotofikasi(dataNa) {
            restyleButton()
            var elementId = "tb-notifikasi";
            $("#loading-tb-notifikasi").hide();
            document.getElementById(elementId).innerHTML =
                '<thead><tr><th>#</th><th>Pemberitahuan</th><th>Waktu</th></tr></thead>'
            var t = "<tbody>";
            let k = 0;
            for (let i = 0; i < 12; i++) {
                k++;
                ...
                tr +=
                    '<td class="text-left align-middle text-sm font-sans" nowrap>Data Nasabah N2390293 harus divalidasi</td>';
